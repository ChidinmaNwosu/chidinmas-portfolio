        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
          <div className="bg-white shadow-lg rounded-lg ">
            ...
            <div className="p-4 ">
              ...
              <button className=" p-2 border-2 hover:bg-mintBrown  hover:text-mintWhite border-mintBrown mr-4 "><Link to="https://carefinder-alt-ec5v.vercel.app/" target="blank" className="  no-underline hover:text-white hover:bg-mintBrown">
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden ">
            ...
            <div className="p-4 ">
              ...
              <button className=" p-2 border-2 hover:bg-mintBrown hover:text-mintWhite border-mintBrown mr-4"><Link to="https://altschool-vue-github-repo.vercel.app/" target="blank" className=" no-underline  hover:text-white hover:bg-mintBrown">
              Live Project</Link></button>
          ...
          <div className="bg-white shadow-lg rounded-lg">
            ...
            <div className="p-4 ">
              ...
              <p className="">Using react to fetch repositories from github, 
                ...
                page that allows you view the details of a single repo...</p>
              <button className=" p-2 border-2 hover:bg-mintBrown hover:text-mintWhite border-mintBrown mr-4 "><Link to="https://altschool-github-repo-portfolio.vercel.app/" target="blank" className=" no-underline  hover:text-white hover:bg-mintBrown">
              Live Project</Link></button>
